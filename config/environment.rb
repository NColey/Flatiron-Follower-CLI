...
require_relative '../views/follow/follow_one_classmate_success.rb'
...
require_relative '../views/tweet/successful_tweet_message.rb'
require_relative '../views/view_timeline/view_student_timeline.rb'
require_relative '../views/view_timeline/timeline_error.rb'
